...
from nodeeditor.var_type_conf import VAR_TYPE_NOT_DEFINED
...
class Socket(Serializable):
    ...
    def __init__(self, node: 'Node', index: int=0, position: int=LEFT_TOP, socket_type: int=1, multi_edges: bool=True,
                 count_on_this_node_side: int=1, is_input: bool=False, supportedTypes: list=[VAR_TYPE_NOT_DEFINED]):
        """
    ...
    def changeSocketPosition(self, position):
        self.position = position

    def changeSocketPositionToStartPosition(self):
    ...
    def serialize(self) -> OrderedDict:
        return OrderedDict([
            ...
            ('supported_types', self.supportedTypes),
            ('socket_visibility', self.grSocket.hiddenStatus),
        ])
    ...
    def deserialize(self, data: dict, hashmap: dict={}, restore_id: bool=True) -> bool:
        try:
            ...
            self.supportedTypes = data['supported_types']
            self.grSocket.hiddenStatus = data['socket_visibility']
