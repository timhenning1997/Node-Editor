...
class Node_ImageShowNode(Abstract_Node):
    def __init__(self, scene: 'Scene', title: str = "Image Show", inputs: list = [VAR_TYPE_PIXMAP], outputs: list = [VAR_TYPE_PIXMAP]):
