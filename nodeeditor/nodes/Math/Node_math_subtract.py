...
class Node_MathSubtractNode(Abstract_Node):
    def __init__(self, scene: 'Scene', title: str = "Subtract", inputs: list = [[VAR_TYPE_FLOAT, VAR_TYPE_INT], [VAR_TYPE_FLOAT, VAR_TYPE_INT]], outputs: list = [[VAR_TYPE_FLOAT, VAR_TYPE_INT]]):
