...
class Node_MathDivideNode(Abstract_Node):
    def __init__(self, scene: 'Scene', title: str = "Divide", inputs: list = [[VAR_TYPE_FLOAT, VAR_TYPE_INT], [VAR_TYPE_FLOAT, VAR_TYPE_INT]], outputs: list = [[VAR_TYPE_FLOAT, VAR_TYPE_INT]]):
