...
class Node_MathMultiplyNode(Abstract_Node):
    def __init__(self, scene: 'Scene', title: str = "Multiply", inputs: list = [[VAR_TYPE_FLOAT, VAR_TYPE_INT], [VAR_TYPE_FLOAT, VAR_TYPE_INT]], outputs: list = [[VAR_TYPE_FLOAT, VAR_TYPE_INT]]):
